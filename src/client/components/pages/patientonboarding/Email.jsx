                    ...
                    <div className="onboarding-content">
                      <div className="row">
                        <div className="col-lg-12">
                          ...
                          <div  onClick={handlelable}  className={` input-placeholder form-focus passcode-wrap mail-box ${lable ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                        ...
                        <div className="col-lg-12">
                          <div className="form-group">
                          <div  onClick={handletinput}  className={` input-placeholder form-focus passcode-wrap mail-box  ${input ? "focused" : "" }`}>
                              <label className="focus-label">
