              ...
              <Link to="/">Login / Signup</Link>
                  ...
                  <ul className="nav header-navbar-rht right-menu">
                    <li className="nav-item">
                      <Link className="nav-link login-blue-bg btn-one" to="/login">
                    ...
                    <li className="nav-item">
                      <Link
                        className="nav-link signup-white-bg btn-one"
                        to="/register"
                      >
                        <i className="me-1"><FeatherIcon icon="user" /></i> Sign Up
                      </Link>
                    </li>
                  </ul>
                </div>
                      ...
                      <div className="app-form app-form-one">
                        <form action="#" className="doctor-form">
                          <div className="row">
                            ...
                            <div className="col-md-12 col-lg-12">
                              <Link to="/patient/search-doctor" className="btn btn-one w-100">
                                Search
                              </Link>
                            </div>
                          </div>
                ...
                <div className="col-lg-4 col-md-6 d-flex">
                  <div className="looking-box w-100 hvr-bounce-to-bottom">
                    ...
                    <div className="looking-btn">
                      <Link to="/patient/booking" className="btn btn-one w-100">
                        <span>Book Now</span>
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-lg-6 col-md-6 d-flex aos" data-aos="fade-up">
                  <div className="doctor-grid w-100">
                    <div className="doctor-details">
                      ...
                      <Link to="/patient/booking" className="btn btn-one">
                        Book Now
                      </Link>
