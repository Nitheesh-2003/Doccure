...
import Clinicfour from './clinicfour'
                ...
                <div className="looking-inner-box">
                  <div className="looking-info-four">
                    ...
                    <p>
                      ...
                      diagnostic services for you diagnostic services for you.
                    </p>
                  </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            ...
            >
              <h2>
                Clinic &amp; <span className="color-primary">Specialities</span>
              </h2>
